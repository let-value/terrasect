...
val generatedAccessConverterResources = layout.buildDirectory.dir("generated/accessConverter/resources")
...
tasks {
    val generateAccessConverterWidener by registering(Copy::class) {
