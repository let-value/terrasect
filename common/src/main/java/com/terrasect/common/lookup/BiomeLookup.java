...
public final class BiomeLookup {
  ...
  private final IdentityHashMap<SelectionRules, Climate.ParameterList<Holder<Biome>>>
      filteredParameterLists;

  private BiomeLookup(
      IdentityHashMap<Holder<Biome>, Entry> metadata,
      IdentityHashMap<SelectionRules, Climate.ParameterList<Holder<Biome>>>
          filteredParameterLists) {
  ...
  public static BiomeLookup build(Climate.ParameterList<Holder<Biome>> parameterList, Region root) {
    ...
    var filteredParameterLists = buildFilteredLists(root, metadata, parameterList);
  ...
  private static IdentityHashMap<SelectionRules, Climate.ParameterList<Holder<Biome>>>
      buildFilteredLists(
          Region root,
          IdentityHashMap<Holder<Biome>, Entry> metadata,
    ...
    for (SelectionRules rules : rulesToPreBake) {
      ...
      var filtered =
          new ArrayList<Pair<Climate.ParameterPoint, Holder<Biome>>>(originalValues.size());
