...
public final class NoiseChunkLookup {
  ...
  public static @Nullable NoiseChunkLookup build(
      @Nullable Context context, int chunkMinX, int chunkMinZ) {
    if (context == null) {
      return null;
    }
  ...
  public @Nullable CompiledNoiseRegistry.CompiledNoiseConstraints getConstraints(
