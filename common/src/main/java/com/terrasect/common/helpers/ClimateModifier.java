...
public final class ClimateModifier {
  ...
  public static Climate.TargetPoint modify(
      ClimateSettings climate, Climate.TargetPoint point, float edgeFactor) {
    ...
    return new Climate.TargetPoint(
        newTemp, newHumidity, newContinentalness, newErosion, newDepth, newWeirdness);
  }
