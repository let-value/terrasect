...
public final class StructureHandler {
    ...
    public static FilterResult checkStructure(SelectionRules rules, String structureId, Set<String> structureTags) {
    ...
    public static boolean isAllowed(SelectionRules rules, String structureId, Set<String> structureTags) {
