...
class ClusterStatisticsTest {
    ...
    void shouldComputeReasonableSiteStatistics() {
        ...
        assertTrue(stats.minSamplesPerSite() >= 800, "Each basin should cover a meaningful footprint");
        assertTrue(stats.minRegionSamples() >= 180, "Regions within basins should avoid single-pixel islands");
