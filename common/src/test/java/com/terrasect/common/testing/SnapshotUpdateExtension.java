...
public final class SnapshotUpdateExtension
  ...
  private static final String CREATED_INITIALLY_PREFIX =
      "Snapshots have been created the first time.";
  ...
  public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext context)
    ...
    return testContext.isSnapshotParameter(type)
        || SnapshotTestContext.class.isAssignableFrom(type);
  }
  ...
  private static boolean shouldIgnore(AssertionError error) {
    ...
    return message.startsWith(CREATED_INITIALLY_PREFIX)
        || message.startsWith(UPDATED_FORCEFULLY_PREFIX);
  }
