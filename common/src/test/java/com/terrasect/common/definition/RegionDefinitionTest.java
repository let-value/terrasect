...
public class RegionDefinitionTest {
  ...
  public void inheritsAndBlocksParentDefinitions() {
    ...
    registry
        ...
        .structures(
            structures -> structures.allowMods("minecraft").requireStructures("minecraft:village"))
    ...
    assertTrue(
        resolved.structures().requiredStructures().stream()
            .noneMatch(id -> id.contains("minecraft:village")));
