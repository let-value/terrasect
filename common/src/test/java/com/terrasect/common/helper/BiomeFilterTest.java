...
public class BiomeFilterTest {
    ...
    public void hasRulesReturnsTrueWithAnyRule() {
        ...
        assertTrue(
                BiomeFilter.hasRules(SelectionRules.builder().allowTags("#test").build()));
        assertTrue(BiomeFilter.hasRules(
                SelectionRules.builder().allowNames("minecraft:test").build()));
        assertTrue(
                BiomeFilter.hasRules(SelectionRules.builder().blockMods("test").build()));
        assertTrue(
                BiomeFilter.hasRules(SelectionRules.builder().blockTags("#test").build()));
        assertTrue(BiomeFilter.hasRules(
