...
public class ClimateModifierTest {
  ...
  public void rangeMapsCenterToCenter() {
    var climate = ClimateSettings.builder().temperature(0.0f, 1.0f).build();
  ...
  public void rangeMapsMinToMin() {
    var climate = ClimateSettings.builder().continentalness(-1.0f, -0.5f).build();
  ...
  public void deepOceanRangeForcesNegativeContinentalness() {
    var oceanClimate = ClimateSettings.builder().continentalness(-1.0f, -0.5f).build();
  ...
  public void fullRangeProducesNoChange() {
    var fullRange = ClimateSettings.builder().temperature(-1.0f, 1.0f).build();
  ...
  public void variationPreservedWithinRange() {
    var climate = ClimateSettings.builder().temperature(0.0f, 0.5f).build();
    ...
    assertNotEquals(
        resultLow.temperature(), resultHigh.temperature(), "Variation should be preserved");
