      ...
      singleplayer
          ...
          .runOnServer(
              server -> {
                ...
                System.out.println(
                    "Player position: (" + blockX + ", " + playerY + ", " + blockZ + ")");

                var level = server.overworld();
                System.out.println("\nBlocks at player column (from Y=100 down to Y=-64):");
                System.out.println(
                    "  Target X,Z: (" + PROBLEM_COORD[0] + ", " + PROBLEM_COORD[2] + ")");
                System.out.println("  ---");
                ...
                for (var y = 100; y >= -64; y--) {
                  ...
                  if (!state.isAir()
                      || (highestSolid != Integer.MIN_VALUE
                          && y >= highestSolid - 3
                          && y <= highestSolid + 5)) {
                ...
                System.out.println(
                    "  Surface height range: Y=" + minSurface + " to Y=" + maxSurface);
